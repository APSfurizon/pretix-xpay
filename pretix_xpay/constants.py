...
XPAY_RESULT_CANCELED = ["Autor. Negata", "Non Creato", "Negato", "Annullato", "Autor. Negata", "Non valido", "Non generato",
                        "Chiuso da backoffice", "Annullato", "Sospeso", "Storno Negato", "Storno Annullato"]
