        ...
        try:
            ...
            if data.status in XPAY_RESULT_AUTHORIZED:
                ...
                try:
                    ...
                    payment.fail(info=_("Tried confirming payment, but quota was exceeded. MANUAL REFUND NEEDED!")) #TODO; Check if manual fail() call is needed
                ...
                payment.fail(info=_("Payment in refund or canceled state")) #TODO: log_data=data gives exception
